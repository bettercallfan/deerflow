...
input_file = "/nfsdat1/home/tyxuslm/paddleocr2/input/倾斜照片.png"
...
pipeline = PaddleOCRVL(
    ...
    vl_rec_server_url='http://219.245.186.43:8000/v1'
)
...
for res in output:
    ...
    res.save_to_markdown(save_path="/nfsdat1/home/tyxuslm/paddleocr2/output/倾斜图片") ## 保存当前图像的markdown格式的结果
